...
7개와 공식 후속 바이너리 8개, 클라이언트 전용 Continuity는 `dependencies.lock.json`의 총 16개 pin을 사용한다. 기존 소스 중
...
2개를 제외하고 Continuity를 추가한 66개가 직접 포함된다. 공식 JAR도 버전·해시·원본 URL을 유지한 채 내장하며,
